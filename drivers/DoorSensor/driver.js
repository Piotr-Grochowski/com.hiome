...
module.exports = class HiomeDoorDriver extends Homey.Driver {
    ...
    async onPairListDevices( data, callback ) {
      ...
      await util.sendGetCommand('/api/1/sensors?type=door',Homey.ManagerSettings.get('primaryCore'))
			.then(result => {
      ...
      {
        await util.sendGetCommand('/api/1/sensors?type=door',Homey.ManagerSettings.get('secondaryCore'))
        .then(result => {
          result.forEach(element => {
